...
/** One entry per real, enforced capability (see services/permissions.js) — nothing here is decorative.
 *  Split into View/Create/Edit/Delete wherever that's a genuinely distinct backend operation; where
 *  viewing was never restricted (Posts, Campaigns, Media, Templates, Social Accounts, Roles), there's
 *  no View key at all — it stays open to any signed-in user, same as before. */
